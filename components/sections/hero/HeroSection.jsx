      ...
      <div style={{ position: "relative" }} className="container">
        ...
        <ul className={s.socials}>
          <li className={s.socials__listItem}>
            <a href="https://www.instagram.com/faaris.mp3/?hl=en">
              <Instagram className={s.socialIcon} />
            </a>
          </li>
          <li className={s.socials__listItem}>
            <a href="https://twitter.com/faaris_mp3">
              <Twitter className={s.socialIcon} />
            </a>
          </li>
          <li className={s.socials__listItem}>
            <a href="https://www.youtube.com/channel/UCWUJDpdUF7NC5HMj6k1s5gA">
              <Youtube className={s.socialIcon} />
            </a>
          </li>
          <li className={s.socials__listItem}>
            <a href="https://soundcloud.com/faarismusic">
              <Soundcloud className={s.socialIcon} />
            </a>
          </li>
          <li className={s.socials__listItem}>
            <a href="https://music.apple.com/us/artist/faaris/1546574247">
              <Itunes className={s.socialIcon} />
            </a>
          </li>
          <li className={s.socials__listItem}>
            <a href="https://open.spotify.com/artist/2wi8Z4BaQWkxQ6W8u8Q6uq">
